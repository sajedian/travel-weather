...
class ColorPickerViewController: UIViewController {
    ...
    private func createButtons(buttonsView: UIView) {
        ...
        let colors = [UIColor.midnightBlue, UIColor.mutedPink, UIColor.darkPurple,
                      UIColor.mediumGray, UIColor.peach, UIColor.darkYellow, UIColor.darkGreen, UIColor.lightBlue]
