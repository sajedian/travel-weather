...
class EditLocationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //configure navigation bar appearance and ensure it isn't altered by search results
        ...
        searchController.searchResultsController?.additionalSafeAreaInsets =
            UIEdgeInsets.init(top: 60, left: 0, bottom: 0, right: 0)
