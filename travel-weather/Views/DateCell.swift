...
class DateCell: JTAppleCell {
    ...
    private func createSelectedView() {
        ...
        selectedLeadingConstraint = selectedView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor,
                                                                          constant: 10)
        selectedTrailingConstraint = selectedView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor,
                                                                            constant: -10)
